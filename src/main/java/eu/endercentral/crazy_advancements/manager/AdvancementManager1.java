...
public class AdvancementManager1 {
	
	private static HashMap<String, AdvancementManager1> accessible = new HashMap<>();
	 ...
	 */
	public static AdvancementManager1 getAccessibleManager(String name) {
		name = name.toLowerCase();
		return accessible.containsKey(name) ? accessible.get(name) : null;
	}
	
	public static Collection<AdvancementManager1> getAccessibleManagers() {
	 ...
	 */
	public AdvancementManager1(Player... players) {
	...
	public static AdvancementManager1 getNewAdvancementManager(Player... players) {
		AdvancementManager1 manager = new AdvancementManager1(players);
		for(Player player : players) {
	...
	public void addAdvancement(eu.endercentral.crazy_advancements.Advancement... advancementsAdded) {
		...
		for(Advancement adv : advancementsAdded) {
			...
			if(y < smallestY) {
				...
				AdvancementManager1.smallestY.put(adv.getTab(), smallestY);
			}
			...
			if(x < smallestX) {
				smallestX = x;
				updatedTabs.add(adv.getTab());
				AdvancementManager1.smallestX.put(adv.getTab(), smallestX);
			}
		}
